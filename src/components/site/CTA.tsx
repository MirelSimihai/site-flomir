      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at 50% 0%, rgba(212,175,55,0.25), transparent 55%)",
            }}
          />
          ...
          <div className="relative z-10 mx-auto max-w-3xl">
            ...
            <div className="mx-auto mb-8 flex h-14 w-14 items-center justify-center rounded-full border border-gold/30 bg-black/30 text-gold">
              <CalendarCheck
                className="h-6 w-6"
                strokeWidth={1.5}
              />
            ...
            <h2 className="mt-6 font-display text-4xl font-light leading-tight tracking-[-0.03em] sm:text-5xl lg:text-6xl">
