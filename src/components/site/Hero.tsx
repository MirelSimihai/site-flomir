    ...
    <section className="relative isolate overflow-hidden bg-radial-spotlight pt-36 pb-28 lg:pt-52 lg:pb-40">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, #F1D27A 0%, transparent 70%)",
          }}
        />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        >
          ...
          <div className="relative rounded-[3rem] border border-gold/30 bg-black p-3 shadow-[0_0_90px_rgba(212,175,55,0.18)]">
