...
import { Aperture, ArrowUpRight, Calendar, CalendarCheck, Camera, CheckCircle2, Cloud, CloudFog, Drum, Facebook, Flower2, GlassWater, Instagram, Mail, MapPin, MessageCircle, Phone, RotateCw, Sparkles, Star, Users, Wine, X } from "lucide-react";
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs(motion.div, {
							...
							children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-gold" }), "Din 2018 • Peste 700 de evenimente realizate"]
						}),
						...
						/* @__PURE__ */ jsxs(motion.div, {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: ["Solicită ofertă personalizată", /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4" })]
							}), /* @__PURE__ */ jsxs("a", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: [
									...
									3,
									4
								].map((i) => /* @__PURE__ */ jsx(Star, { className: "h-3.5 w-3.5 fill-gold text-gold" }, i))
				...
				/* @__PURE__ */ jsxs(motion.div, {
					...
					children: [/* @__PURE__ */ jsx("div", { className: "absolute h-[500px] w-[500px] rounded-full bg-gold/20 blur-[140px]" }), /* @__PURE__ */ jsxs("div", {
						className: "relative rounded-[3rem] border border-gold/30 bg-black p-3 shadow-[0_0_90px_rgba(212,175,55,0.18)]",
						children: [/* @__PURE__ */ jsx("div", { className: "absolute left-1/2 top-5 z-20 h-5 w-24 -translate-x-1/2 rounded-full bg-black" }), /* @__PURE__ */ jsxs("div", {
							...
							}), /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-tr from-transparent via-white/5 to-white/10" })]
						})]
					})]
				}),
				/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: services.map((s, i) => {
					...
					return /* @__PURE__ */ jsxs(motion.article, {
						...
						children: [s.featured ? /* @__PURE__ */ jsxs(Fragment, { children: [
						...
						}), /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/95 via-black/45 to-black/10" })] }), /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: ["Descoperă serviciul", /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-3 w-3 transition-transform group-hover:translate-x-1" })]
									})
								]
							})]
						})]
...
//#endregion
//#region src/components/site/Portfolio.tsx
var ease$4 = [
	.22,
	1,
	.36,
...
function Portfolio() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		className: "relative py-28 lg:py-40",
		children: [
			/* @__PURE__ */ jsx("div", { className: "absolute left-1/2 top-20 -z-10 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-gold/10 blur-[140px]" }),
			/* @__PURE__ */ jsxs("div", {
				className: "mx-auto max-w-7xl px-6 lg:px-10",
				children: [
					/* @__PURE__ */ jsxs(motion.div, {
					...
					/* @__PURE__ */ jsx(motion.div, {
						...
						children: /* @__PURE__ */ jsx(AnimatePresence, { children: visibleImages.map((img, i) => /* @__PURE__ */ jsx(motion.div, {
							layout: true,
							initial: {
								opacity: 0,
								y: 30
							...
							children: /* @__PURE__ */ jsxs("button", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-70 transition duration-700 group-hover:opacity-20" }),
									/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 rounded-[2rem] border border-transparent transition duration-500 group-hover:border-gold/40" })
								]
							})
						}, img.src)) })
					}),
			...
			/* @__PURE__ */ jsx(AnimatePresence, { children: selected && /* @__PURE__ */ jsxs(motion.div, {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(motion.div, {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-5 w-5 text-gold" }), item]
							}, item))
						})
					]
				}), /* @__PURE__ */ jsxs(motion.div, {
					...
					className: "relative",
					children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 rounded-[2.5rem] bg-gold/20 blur-[80px]" }), /* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs(motion.div, {
				...
				children: steps.map((s, i) => /* @__PURE__ */ jsxs(motion.li, {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { className: "relative mt-6 h-px w-12 bg-gold/40" }),
						/* @__PURE__ */ jsx("h3", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: ["Solicită ofertă", /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4" })]
							}), /* @__PURE__ */ jsxs("a", {
								href: "https://wa.me/40740593755",
								target: "_blank",
								rel: "noreferrer",
								...
								children: [/* @__PURE__ */ jsx(MessageCircle, { className: "h-4 w-4 text-gold" }), "WhatsApp direct"]
							})]
						}),
						/* @__PURE__ */ jsx("p", {
...
function Contact() {
	return /* @__PURE__ */ jsxs("section", {
		id: "contact",
		className: "relative overflow-hidden py-28 lg:py-40",
		children: [/* @__PURE__ */ jsx("div", { className: "absolute left-1/2 top-1/2 -z-10 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gold/10 blur-[150px]" }), /* @__PURE__ */ jsxs("div", {
			className: "mx-auto max-w-7xl px-6 lg:px-10",
			children: [
				/* @__PURE__ */ jsxs(motion.div, {
					initial: {
